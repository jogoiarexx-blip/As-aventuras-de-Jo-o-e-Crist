/** 16-bit sprite renderer v0.9.3-16BIT - frames reais, hitbox independente */
(()=>{
...
const imgs={};for(const [k,d] of Object.entries(defs)){const i=new Image();i.src=A+d.file;imgs[k]=i;}
...
install(typeof Enemy!=='undefined'?Enemy:null,null);install(typeof BasicEnemy!=='undefined'?BasicEnemy:null,'capanga');install(typeof CapangaEnemy!=='undefined'?CapangaEnemy:null,'capanga');install(typeof CowboyEnemy!=='undefined'?CowboyEnemy:null,'cowboy');install(typeof StrongEnemy!=='undefined'?StrongEnemy:null,'strong');install(typeof CiclistaEnemy!=='undefined'?CiclistaEnemy:null,'ciclista');install(typeof TankEnemy!=='undefined'?TankEnemy:null,'tank');install(typeof CockroachEnemy!=='undefined'?CockroachEnemy:null,'cockroach');install(typeof FastEnemy!=='undefined'?FastEnemy:null,'fast');install(typeof BerserkerEnemy!=='undefined'?BerserkerEnemy:null,'berserker');
})();
