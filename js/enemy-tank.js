...
class TankEnemy {
    constructor(x, y) {
        ...
        console.log('✅ TANK criado em:', this.x, this.y, 'Ground:', this.groundY);
        ...
        console.log(`✅ Tank hitbox: ${this.hitbox.width}×${this.hitbox.height} (${Math.round((this.hitbox.width * this.hitbox.height) / (this.w * this.h) * 100)}% da área)`);
    }
