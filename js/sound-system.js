...
class SoundSystem {
    constructor() {
        ...
        this.soundCooldownMs = { hit:28, enemyHit:35, punch:30, kick:45, playerHurt:80, menuMove:45, fuse:110, busCollision:120, busLaneChange:130, busNearMiss:180, busWarning:650 };
        ...
        this.soundVolumeScale = { hit:.68, enemyHit:.72, punch:.78, kick:.82, playerHurt:.82, ko:.88, shoot:.78, explosion:.80, busCollision:.82, dogBark:.72, menuMove:.72, busLaneChange:.42, busNearMiss:.48, busWarning:.52 };
        this._lastPlayedAt = {};
