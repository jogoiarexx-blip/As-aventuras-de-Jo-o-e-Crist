...
class TechBoss extends Enemy {
    constructor(x, y) {
        ...
        console.log('👹 ENGENHEIRO spawnado!');
    }
...
class GodBoss extends Enemy {
    constructor(x, y) {
        ...
        console.log('👹👑 DEUS DAS APOSTAS spawnado!');
    }
...
console.log('✅ Bosses TechBoss, ShadowBoss e GodBoss carregados!');
